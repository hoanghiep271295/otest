...
namespace IS.uni{
public class STUDENTRESULTTYPE_OBJ: BusinessObject<STUDENTRESULTTYPE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTRESULTTYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTRESULTTYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("MINMARK",18,"DECIMAL",2)
