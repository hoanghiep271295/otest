...
namespace IS.uni{
public class STUDENTREWARDLEVEL_OBJ: BusinessObject<STUDENTREWARDLEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTREWARDLEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTREWARDLEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
