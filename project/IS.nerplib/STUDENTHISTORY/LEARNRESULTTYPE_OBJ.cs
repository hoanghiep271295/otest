...
namespace IS.uni{
public class LEARNRESULTTYPE_OBJ: BusinessObject<LEARNRESULTTYPE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public LEARNRESULTTYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public LEARNRESULTTYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("MINLEVEL",0,"FLOAT",0)
,new fieldInfo("MAXLEVEL",0,"FLOAT",0)
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
    ...
    public virtual System.Double MINLEVEL
    {
        get ;
        set ;
    }
    public virtual System.Double MAXLEVEL
    {
        get ;
        set ;
    }
