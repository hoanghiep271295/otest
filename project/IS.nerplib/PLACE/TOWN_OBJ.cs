...
namespace IS.uni{
public class TOWN_OBJ: BusinessObject<TOWN_OBJ.BusinessObjectID>
{
	[Serializable]
...
,new fieldInfo("POSTCODE",10,"VARCHAR",0)
,new fieldInfo("MAILCODE",10,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("DISTRICT", "CODE", "PARENTCODE")]
   public DISTRICT_OBJ _PARENTCODE;
