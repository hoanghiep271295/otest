...
namespace IS.uni{
public class PROVINCEREFERENCE_OBJ: BusinessObject<PROVINCEREFERENCE_OBJ.BusinessObjectID>
{
	[Serializable]
...
,new fieldInfo("WHOIS",64,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("PROVINCE", "CODE", "THECODE")]
   public PROVINCE_OBJ _THECODE;
 [tablereference("PROVINCE", "CODE", "CURRENTCODE")]
   public PROVINCE_OBJ _CURRENTCODE;
