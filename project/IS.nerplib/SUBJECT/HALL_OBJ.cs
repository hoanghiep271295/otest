...
namespace IS.uni{
public class HALL_OBJ: BusinessObject<HALL_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "H{SHORD}{CCCC}";
...
//##fieldList##
	...
	public HALL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("SCHEDULECODE",10,"VARCHAR",0)
,new fieldInfo("BRANCHCODE",10,"VARCHAR",0)
,new fieldInfo("HOUSE",10,"VARCHAR",0)
,new fieldInfo("AMOUNT",0,"INT",0)
,new fieldInfo("SPECIALIZATION",10,"VARCHAR",0)
...
,new fieldInfo("LANG",10,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("BRANCH", "CODE", "BRANCHCODE")]
   public BRANCH_OBJ _BRANCHCODE;
    ...
    public virtual System.String SCHEDULECODE
    {
        get ;
        set ;
    }
    ...
    public virtual System.String HOUSE
    {
        get ;
        set ;
    }
    ...
    public virtual System.String SPECIALIZATION
    {
        get ;
        set ;
    }
