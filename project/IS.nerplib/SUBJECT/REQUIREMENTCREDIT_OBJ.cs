...
namespace IS.uni{
public class REQUIREMENTCREDIT_OBJ: BusinessObject<REQUIREMENTCREDIT_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public REQUIREMENTCREDIT_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public REQUIREMENTCREDIT_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("CREDITMIN",0,"INT",0)
,new fieldInfo("CREDITMAX",0,"INT",0)
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
   ...
   public EDUCATIONTYPE_OBJ _EDUCATIONTYPECODE;
    ...
    public virtual System.Int32 CREDITMIN
    {
        get ;
        set ;
    }
    public virtual System.Int32 CREDITMAX
    {
        get ;
        set ;
    }
