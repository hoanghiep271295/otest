...
namespace IS.uni{
public class ACADEMICLEVELHISTORY_OBJ: BusinessObject<ACADEMICLEVELHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public ACADEMICLEVELHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public ACADEMICLEVELHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("RESEARCHSTATUSLINK",0,"INT",0)
...
,new fieldInfo("STAFFINFOCODE",10,"VARCHAR",0)
 ...
 [tablereference("STAFFINFO", "CODE", "STAFFINFOCODE")]
   public STAFFINFO_OBJ _STAFFINFOCODE;
    ...
    public virtual System.Int32 RESEARCHSTATUSLINK
    {
        get ;
        set ;
    }
