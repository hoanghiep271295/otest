...
namespace IS.uni{
public class ACEDEMICTITLEHISTORY_OBJ: BusinessObject<ACEDEMICTITLEHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public ACEDEMICTITLEHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public ACEDEMICTITLEHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
