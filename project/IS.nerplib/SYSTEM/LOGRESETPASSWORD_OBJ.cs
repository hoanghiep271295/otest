...
namespace IS.uni{
public class LOGRESETPASSWORD_OBJ: BusinessObject<LOGRESETPASSWORD_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public LOGRESETPASSWORD_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public LOGRESETPASSWORD_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("REQUIRESTAFF",10,"VARCHAR",0)
,new fieldInfo("PASSWORD",100,"VARCHAR",0)
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("STAFF", "CODE", "REQUIRESTAFF")]
   public STAFF_OBJ _REQUIRESTAFF;
    ...
    public virtual System.String REQUIRESTAFF
    {
        get ;
        set ;
    }
