...
namespace IS.uni{
public class ADMINGROUP_OBJ: BusinessObject<ADMINGROUP_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "D{SHORD}{CCCC}";
...
//##fieldList##
	...
	public ADMINGROUP_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public ADMINGROUP_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
