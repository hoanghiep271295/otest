...
namespace IS.uni{
public class ACADEMICTITLE_OBJ: BusinessObject<ACADEMICTITLE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public ACADEMICTITLE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public ACADEMICTITLE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("RATE",0,"FLOAT",0)
    ...
    [Display(Name="Tải giảng dạy (giáo viên quân sự)")]
    public virtual System.Int32 EDUDUTY1
    {
        get ;
        set ;
    }
    [Display(Name="Tải nghiên cứu (Giáo viên quân sự)")]
