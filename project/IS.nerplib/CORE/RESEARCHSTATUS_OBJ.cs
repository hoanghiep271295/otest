...
namespace IS.uni{
public class RESEARCHSTATUS_OBJ: BusinessObject<RESEARCHSTATUS_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	private System.String _THETYPE;
		...
		public BusinessObjectID(System.Int32 mCODELINK,System.String mTHETYPE)
		{
		_CODELINK = mCODELINK;
		_THETYPE = mTHETYPE;
    ...
    public System.String THETYPE
    {
		...
		{
			return CODELINK.GetHashCode() ^ THETYPE.GetHashCode();
		}
