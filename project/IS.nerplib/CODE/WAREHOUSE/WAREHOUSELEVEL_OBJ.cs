...
namespace IS.uni{
public class WAREHOUSELEVEL_OBJ: BusinessObject<WAREHOUSELEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public WAREHOUSELEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public WAREHOUSELEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("OFFICE",0,"INT",0)
    ...
    public virtual System.Int32 OFFICE
    {
        get ;
        set ;
    }
