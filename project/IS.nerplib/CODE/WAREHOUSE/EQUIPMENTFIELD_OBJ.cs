...
namespace IS.uni{
public class EQUIPMENTFIELD_OBJ: BusinessObject<EQUIPMENTFIELD_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public EQUIPMENTFIELD_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public EQUIPMENTFIELD_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
