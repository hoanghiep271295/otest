...
namespace IS.uni{
public class EQUIPMENTGROUP_OBJ: BusinessObject<EQUIPMENTGROUP_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public EQUIPMENTGROUP_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public EQUIPMENTGROUP_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
