...
namespace IS.uni{
public class QUANTITY_OBJ: BusinessObject<QUANTITY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public QUANTITY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("BASECODE",10,"VARCHAR",0)
,new fieldInfo("RATE",5,"DECIMAL",2)
    ...
    public virtual System.String BASECODE
    {
        get ;
        set ;
    }
