...
namespace IS.uni{
public class DEPARTMENTADMINGROUP_OBJ: BusinessObject<DEPARTMENTADMINGROUP_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public DEPARTMENTADMINGROUP_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public DEPARTMENTADMINGROUP_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
