...
namespace IS.uni{
public class DISTRICTREFERENCE_OBJ: BusinessObject<DISTRICTREFERENCE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public DISTRICTREFERENCE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public DISTRICTREFERENCE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("WHOIS",64,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("DISTRICT", "CODE", "THECODE")]
   public DISTRICT_OBJ _THECODE;
 [tablereference("DISTRICT", "CODE", "CURRENTCODE")]
   public DISTRICT_OBJ _CURRENTCODE;
