...
namespace IS.uni{
public class PRIORITYREGION_OBJ: BusinessObject<PRIORITYREGION_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public PRIORITYREGION_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public PRIORITYREGION_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
