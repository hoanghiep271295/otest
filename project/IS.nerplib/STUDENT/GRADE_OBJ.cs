...
namespace IS.uni{
public class GRADE_OBJ: BusinessObject<GRADE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public GRADE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
   ...
   public EDUCATIONLEVEL_OBJ _EDUCATIONLEVELCODE;
    ...
    public virtual System.Int32 YEARIN
    {
        get ;
        set ;
    }
    ...
    public virtual System.Int32 YEAROUT
    {
        get ;
        set ;
    }
