var ReligionList = React.createClass( {
    getInitialState: function() {
        return {
            ...
            parentcode: '',
            parentname:'',
            parentnamedef: 'Danh mục tôn giáo 222',
            parentextcode: ''
        };
    },
    ...
    componentDidMount: function () {
	    ...
	    //this.loadTree();
	    //Thiết lập tiêu đề
        setTitle('sys_title', 'Danh mục tôn giáo');
            //Thiết lập đường dẫn
        var path = [{ title: 'Danh mục tôn giáo', status: 'active', link: '' }];
        setTree('sys_path', path);
        ////Thiết lập lựa chọn mặc định trên cây
        //if(this.state.currentcode!=='')
        //{
        //    $('#religion_list_tree').jstree('select_node', this.state.currentcode);
        //}
...
*/
    ...
    //        var objurl = { Page: 'currentpage', Url: '/Religion/index/'+code };
...
//        console.log(obj);
    ...
    */
    onNewClick: function () {
        ...
        this.refs.ReligionPopup.ClearInput(obj);
        this.refs.ReligionPopup.Show();
    ...
    */
    onEidtClick: function () {
        ...
        else
        {
            ...
            //gọi hàm từ trong đối tượng popup form để thiết lập tham số, sau đó hiển thị
            this.refs.ReligionPopup.SetInput(obj);
            this.refs.ReligionPopup.Show();
            console.log(obj);
        }
    ...
    */
    searchCallback(lst)
    {
        var name = lst.searchReligion_name.value;
        var nametype = lst.searchReligion_name.type;
        var note = lst.searchReligion_note.value;
        var notetype = lst.searchReligion_note.type;
    ...
    render: function () {
        ...
        var searchconfig = [{ title: 'Tên TG', id: 'searchReligion_name', type: 'text', combo: 'block' }, { title: 'Ghi chú', id: 'searchReligion_note', type: 'text', combo: 'block' }];
        return(
    <div className="box">
        <div className="row">
            ...
            <div className="row">
                ...
                <ButtonList list={this.state.buts} />
                    ...
                    <SearchDialog title='Tìm kiếm tôn giáo' lst={searchconfig} callback={this.searchCallback} ref='ReligionSearch' />
                       <ReligionPopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref="ReligionPopup" />
