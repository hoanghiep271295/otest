              ...
              <div className="box-body">
                ...
                <div className="form-group">
                  ...
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id={id + '_CODEVIEW'} ref={id + '_CODEVIEW'} placeholder="Mã tôn giáo" />
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Tên tôn giáo</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id={id + '_NAME'} ref={id + '_NAME'} placeholder="Tên tôn giáo" />
                  </div>
                </div>
                <div className="form-group">
