...
var SubjectContentPopup = React.createClass({
    ...
    Show: function () {
        ...
        var c = this.refs["CONTENTTYPE"].getValueString();
        setTimeout(function() {
    ...
    */
    ClearThing:function()
    {
        ...
        this.refs["CONTENTTYPE"].setValueString(this.state.lstContentType[0].CODE);
   ...
   */
    SaveData: function (isClose) {
        ...
        note = note.replace(new RegExp('src="ContentQuestion', 'g'), 'src="/ContentQuestion');
        note = note.replace(new RegExp('src="../../ContentQuestion', 'g'), 'src="/ContentQuestion');
        var parentcode = '';
