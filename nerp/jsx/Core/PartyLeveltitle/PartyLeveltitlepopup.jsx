 ...
 */
var PartyleveltitlePopup = React.createClass({
    ...
    */
    ClearThing:function()
    {
       ...
       // this.refs.txtTheorder.value = '';
        ...
        this.refs[this.props.id + '_COMPARELEVEL'].value = '';
    ...
    */
    SetInput: function (obj) {
        ...
        this.refs[this.props.id + '_COMPARELEVEL'].value = obj.COMPARELEVEL;
...
//        console.log("Ghi dữ liệu");
      ...
      //  var THEORDER = this.refs.txtTheorder.value;
        ...
        var THEORDER = this.refs[this.props.id + '_THEORDER'].value;
        var COMPARELEVEL = this.refs[this.props.id + '_COMPARELEVEL'].value;
        var LOCK = 0;
    ...
    <div className="modal-dialog">
          <div className="box box-info">
            ...
            <div className="box-header with-border">
              ...
              <h3 className="box-title">Cập nhật chức vụ Đảng</h3>
            ...
            <form className="form-horizontal">
              <div className="box-body">
                ...
                <div className="form-group">
                  <label htmlFor="txtCodeview" className="col-sm-3 control-label">Mã chức vụ Đảng</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id={id + '_CODEVIEW' } ref={id + '_CODEVIEW' } placeholder="Mã chức vụ" />
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Tên chức vụ</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id={id + '_NAME' } ref={id + '_NAME' } placeholder="Tên chức vụ" />
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Thứ tự</label>
                  <div className="col-sm-9">
                    <input type="number" className="form-control" id={id + '_THEORDER'} ref={id + '_THEORDER' } placeholder="Thứ tự" />
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Mức</label>
                  <div className="col-sm-9">
                    <input type="number" className="form-control" id={id + '_COMPARELEVEL'} ref={id + '_COMPARELEVEL' } placeholder="Mức so sánh" />
                  </div>
                </div>
                <div className="form-group">
