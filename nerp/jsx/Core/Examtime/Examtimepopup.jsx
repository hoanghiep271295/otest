 ...
 */
var ExamTimePopup = React.createClass({
    ...
    */
    ClearThing:function()
    {
        ...
        this.refs[this.props.id + "_STUDENTAMOUNTHALL"].value = "";
        this.refs[this.props.id + "_TESTCOUNT"].value = "",
    ...
    */
    SetInput: function (obj) {
        ...
        this.refs[this.props.id + "_STUDENTAMOUNTHALL"].value = obj.STUDENTAMOUNTHALL;
        this.refs[this.props.id + "_TESTCOUNT"].value = obj.TESTCOUNT,
        this.refs[this.props.id + "_YEAR"].value = obj.YEAR;
        this.refs[this.props.id + "_TERM"].value = obj.TERM;
        this.refs["TESTSTRUCTCODE"].setValue(obj.TESTSTRUCTCODE);
        //Set status
   ...
   */
    SaveData: function (isClose) {
        ...
        var data = {
            ...
            STUDENTAMOUNTHALL: this.refs[this.props.id + "_STUDENTAMOUNTHALL"].value,
            TESTCOUNT: this.refs[this.props.id + "_TESTCOUNT"].value,
            TERM: this.refs[this.props.id + "_TERM"].value,
            TESTSTRUCTCODE: this.refs["TESTSTRUCTCODE"].getValueString()
    }
        //Add or edit 1 item
        $.ajax({
            url: "/Examtime/Update",
                  ...
                  <div className="modal-dialog">
                    <div className="box box-info">
                      <div className="modal-header with-border">
                        ...
                        <h4 className="modal-title" id={id+"_form_title"} ref={id+"_form_title"}>Thêm khóa</h4>
                      </div>
                      <div className="modal-body">
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Cấu trúc đề</label>
                                  <div className="col-sm-10">
                                       <Combobox lst={this.props.listTestStruct} valuefield='CODE' textfield='{NAME}' id='TESTSTRUCTCODE' callback={''} tooltip="Click hoặc space chọn" multiple={false} ref='TESTSTRUCTCODE' />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Năm học</label>
                                  <div className="col-sm-4">
                                      <input type="number" className="form-control" id={id + "_YEAR"} ref={id + "_YEAR"} />
                                  </div>
                                   <label className="col-sm-2 control-label">Học kỳ</label>
                                  <div className="col-sm-4">
                                      <input type="number" className="form-control" id={id + "_TERM"} ref={id + "_TERM"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Số đề thi</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_TESTCOUNT"} ref={id + "_TESTCOUNT"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Số sinh viên 1 phòng</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_STUDENTAMOUNTHALL"} ref={id + "_STUDENTAMOUNTHALL"} />
                                  </div>
                              </div>
                              <div className="form-group">
