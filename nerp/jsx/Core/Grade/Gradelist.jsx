    ...
    getInitialState: function() {
        return {
            ...
            columnDefs: [
                ...
                { headerName: "Năm vào", field: "YEARIN", width: 100, editable: false },
                { headerName: "Năm ra", field: "YEAROUT", width: 100, editable: false },
...
//        console.log('RowSelect:', itemSelect);
        ...
        this.props.parent.setKeyValue('grade', itemSelect);
...
*/
    loadData: function (obj, selectobject) {
        ...
        if (!!obj.YEARIN) {
            yearin = obj.YEARIN.value;
        }
        if (!!obj.YEAROUT) {
            yearout = obj.YEAROUT.value;
        }
        $.ajax({
            url: "/Grade/getAllSearch",
            dataType: 'json',
            data: {
                page: page
                , pageSize: pageSize
...
*/
   ...
   */
    onPrint: function () {
        ...
        var parameter = "code=" + this.state.currentcode + "&reporttype=Grade";
    ...
    render: function () {
        return (
                ...
                {/*Cần phải gán ref để truy xuất đến đối tượng này*/}
                 <GradePopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
