...
var SysmenuList = React.createClass({
    ...
    getInitialState: function getInitialState() {
        return {
            ...
            columnDefs: [{ headerName: "Tên", field: "NAME", width: 450, editable: false }, { headerName: "Không hiển thị", field: "LOCK", width: 150, editable: false, type: 'checkbox' }, { headerName: "Thứ tự", field: "THEORDER", width: 100, align: 'center', editable: false }, { headerName: "Biểu tượng", field: "ICON", width: 150, align: 'center', editable: false }, { headerName: "Liên kết", field: "LINK", width: 200, align: 'center', editable: false }, { headerName: "Phân quyền", field: "PRIORITYCODE", width: 200, align: 'center', editable: false }],
            //Danh sách trên cây
            lst: [], currentcode: '',
    ...
    */
    TreeSelect: function TreeSelect(obj) {
    ...
    */
    initAgGrid: function initAgGrid(setRowData, getDataChange, setNextRow, setPrevRow) {
        var agGrid = {
    ...
    */
    loadDataSearch: function loadDataSearch(name, nametype, note, notetype) {
        var currentcode = this.state.currentcode;
        var thetype = this.refs.hidTheType.value;
    ...
    */
    ReloadList: function ReloadList(obj) {
        //        console.log(obj);
        //cập nhật lại cây
        this.loadTree();
    ...
    */
    ReloadListDelete: function ReloadListDelete() {
        //        console.log(obj);
        //cập nhật lại cây
        this.loadTree();
        //cập nhật lại danh sách
    ...
    */
    onRowSelect: function onRowSelect(itemSelect) {
    ...
    */
    onEidtClick: function onEidtClick() {
    ...
    */
    searchCallback: function searchCallback(lst) {
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "row" },
                React.createElement("input", { type: "hidden", value: "BACKEND", ref: "hidTheType", id: "hidTheType" }),
                React.createElement(
                    "div",
                    { className: "col-xs-3", style: { borderRight: '1px solid gray', minHeight: 550 } },
                    React.createElement(
                        "a",
                        { href: "#", onClick: function () {
                                return _this.TreeSelect(null);
                            } },
                        "Hệ thống menu"
                    ),
                    React.createElement(Tree, { id: "sysmenu_list_tree", data: this.state.lst, mapper: config, callback: this.TreeSelect, height: "450px" })
                ),
                React.createElement(
                    "div",
                    { className: "col-xs-9" },
                    React.createElement(ButtonList, { list: this.state.buts }),
                    React.createElement(
                        "div",
                        { id: "listSubCon", className: "tab-pane fade  in active" },
                        React.createElement(SysmenuPopup, { setData: this.setData, onPre: this.onPrevClick, onNext: this.onNextClick, ReloadData: this.ReloadList, ref: "sysmenuPopup" }),
                        React.createElement(SearchDialog, { title: "Tìm kiếm menu", lst: searchconfig, callback: this.searchCallback, ref: "sysmenuSearch" }),
                        React.createElement("div", { id: "myGridSQ", className: "ag-fresh", style: { width: '100%', height: '400px' } }),
                        React.createElement(AgGrid, { container: "myGridSQ",
...
//----------------
ReactDOM.render(React.createElement(SysmenuList, null), document.getElementById('container'));
