var NationList = React.createClass( {
    ...
    componentDidMount: function () {
	    //Thiết lập tiêu đề
        setTitle('sys_title', 'Danh mục quốc gia');
        //Thiết lập đường dẫn
        var path = [{ title: 'Danh mục quốc gia', status: 'active', link: '' }];
    ...
    */
    onNewClick: function () {
        ...
        this.refs.NationPopup.ClearInput(obj);
        this.refs.NationPopup.Show();
    ...
    */
    onEidtClick: function () {
        ...
        else
        {
            ...
            //gọi hàm từ trong đối tượng popup form để thiết lập tham số, sau đó hiển thị
            this.refs.NationPopup.SetInput(obj);
            this.refs.NationPopup.Show();
            console.log(obj);
        }
    },
    ...
    */
    ...
    onReportClick: function () {
        ...
        var parameter="code="+this.state.currentcode+"&reporttype=NATION";
    ...
    */
    searchCallback(lst)
    {
        var name = lst.searchNation_name.value;
        var nametype = lst.searchNation_name.type;
        var note = lst.searchNation_note.value;
        var notetype = lst.searchNation_note.type;
    ...
    render: function () {
        ...
        var searchconfig = [{ title: 'Tên', id: 'searchNation_name', type: 'text', combo: 'block' }, { title: 'Ghi chú', id: 'searchNation_note', type: 'text', combo: 'block' }];
        return(
    <div className="box">
        <div className="row">
            ...
            <div className="row">
                ...
                <ButtonList list={this.state.buts} />
                    ...
                    <SearchDialog title='Tìm kiếm' lst={searchconfig} callback={this.searchCallback} ref='NationSearch' />
                       <NationPopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref="NationPopup" />
