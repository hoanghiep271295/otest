 ...
 */
var StudentPopup = React.createClass({
    ...
    */
    ClearThing:function()
    {
        ...
        this.refs[this.props.id + "_SEX"].value = -1;
        this.refs[this.props.id + "_ADDRESS"].value = "";
        this.refs[this.props.id + "_EMAIL"].value = "";
        this.refs[this.props.id + "_PHONE"].value = "";
        this.refs[this.props.id + "_BIRTHDAY"].value = "";
        //Set status
    ...
    */
    SetInput: function (obj) {
        ...
        this.refs[this.props.id + "_BIRTHDAY"].value = moment(obj.BIRTHDAY).format('YYYY-MM-DD');
        this.refs[this.props.id + "_SEX"].value = obj.SEX;
        this.refs[this.props.id + "_ADDRESS"].value = obj.ADDRESS;
        this.refs[this.props.id + "_EMAIL"].value = obj.EMAIL;
        this.refs[this.props.id + "_PHONE"].value = obj.PHONE;
        //Set status
   ...
   */
    SaveData: function (isClose) {
        ...
        var classCode = '';
        if (!!objClass)
            classCode = objClass[0].CODE;
        var objGrade = this.props.parent.getKeyValue('grade');
        var gradeCode = '';
        if (!!objGrade)
            gradeCode = objGrade[0].CODE;
        var data = {
            ...
            SEX: this.refs[this.props.id + "_SEX"].value,
            PHONE: this.refs[this.props.id + "_PHONE"].value,
            BIRTHDAY: this.refs[this.props.id + "_BIRTHDAY"].value,
            ADDRESS: this.refs[this.props.id + "_ADDRESS"].value,
            EMAIL: this.refs[this.props.id + "_EMAIL"].value,
            GRADECODE: gradeCode,
            CLASSCODE: classCode
                  ...
                  <div className="modal-dialog">
                    <div className="box box-info">
                      <div className="modal-header with-border">
                        ...
                        <h4 className="modal-title" id={id+"_form_title"} ref={id+"_form_title"}>Thêm sinh viên</h4>
                      </div>
                      <div className="modal-body">
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-sm-10">
                                      <input type="date" className="form-control" id={id + "_BIRTHDAY"} ref={id + "_BIRTHDAY"}/>
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Giới tính</label>
                                  <div className="col-sm-10">
                                      <select className="form-control" id={id + "_SEX"} ref={id + "_SEX"}>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_PHONE"} ref={id + "_PHONE"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Địa chỉ</label>
                                  <div className="col-sm-10">
                                      <input type="text" className="form-control" id={id + "_ADDRESS"} ref={id + "_ADDRESS"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Email</label>
                                  <div className="col-sm-10">
                                      <input type="email" className="form-control" id={id + "_EMAIL"} ref={id + "_EMAIL"} />
                                  </div>
                              </div>
                              <div className="form-group">
