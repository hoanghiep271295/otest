 ...
 */
var QuestionAppPopup = React.createClass({
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.lst.length > 0)
                    this.refs["CONTENTTYPE"].setValueString(data.lst[0].CODE);
            }.bind(this),
    ...
    */
    SetInput: function (obj) {
        ...
        console.log(this.refs["CONTENTTYPE"].getValueString());
                      ...
                      <div className="modal-body">
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                 ...
                                 <div className="col-sm-10">
                                   <Combobox lst={this.state.lstContentType} valuefield='CODE' textfield='{NAME}' id='CONTENTTYPE' callback={this.loadTree} tooltip="Click hoặc space chọn" multiple={false} ref='CONTENTTYPE' />
                                 </div>
                                              </div>
