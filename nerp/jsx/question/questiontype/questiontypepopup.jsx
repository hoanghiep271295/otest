 ...
 */
var QuestiontypePopup = React.createClass({
...
<div className="modal fade" id={id} ref={id} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div className="modal-dialog">
          <div className="box box-info">{/*Tiêu đề của form*/}
            <div className="box-header with-border">
              ...
              <h3 className="box-title">Các loại câu hỏi</h3>
            ...
            <form className="form-horizontal">
              <div className="box-body">
                ...
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Tên loại câu hỏi</label>
                  <div className="col-sm-9">
