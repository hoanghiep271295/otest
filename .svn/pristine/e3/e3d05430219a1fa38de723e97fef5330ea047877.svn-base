...
{
    public class ArmyRankController : Controller
    {
        ...
        public ActionResult Index(string id)
        {
            ...
            string[] jsx = {
                ...
                ,"/jsx/Core/Armyrank/Armyrankpopup.jsx"
                ,"/jsx/Core/Armyrank/Armyranklist.jsx"
                };
            ViewBag.jsx = jsx;
        ...
        public JsonResult delete(List<string> code)
        {
            int ret = 0;
            ARMYRANK_BUS bus = new ARMYRANK_BUS();
            List<ARMYRANK_OBJ.BusinessObjectID> li_del = new List<ARMYRANK_OBJ.BusinessObjectID>();
            foreach (string item in code)
            {
                li_del.Add(new ARMYRANK_OBJ.BusinessObjectID(item));
        ...
        public JsonResult update(ARMYRANK_OBJ obj)
        {
            ...
            ARMYRANK_OBJ obj_temp = null;
            //kiểm tra tồn tại cho trường hợp sửa
            if (!string.IsNullOrEmpty(obj.CODE))//edit
            {
                obj_temp = bus.GetByID(new ARMYRANK_OBJ.BusinessObjectID(obj.CODE));
                if (obj_temp == null )
                {
                    ret = -4;
                }
