...
namespace IS.uni{
public class EDUCATIONFIELD_OBJ: BusinessObject<EDUCATIONFIELD_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "F{SHORD}{CCCC}";
...
//##fieldList##
	...
	public EDUCATIONFIELD_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public EDUCATIONFIELD_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
