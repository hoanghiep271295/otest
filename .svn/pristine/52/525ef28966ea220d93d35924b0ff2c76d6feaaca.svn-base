 ...
 */
var ArmyrankPopup = React.createClass({
                  ...
                  <div className="modal-dialog">
                    <div className="box box-info">
                      <div className="modal-header with-border">
                        ...
                        <h4 className="modal-title" id={id+"_form_title"} ref={id+"_form_title"}>Cập nhật quân hàm</h4>
                      </div>
                      <div className="modal-body">
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-sm-10">
                                      <input type="text" className="form-control" id={id+"_NAME"} ref={id+"_NAME"}  placeholder="Tên" />
                                  </div>
                              </div>
                            <div className="form-group">
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-sm-10">
                                      <textarea className="form-control" rows="4" id={id+"_NOTE"} ref={id+"_NOTE"}  placeholder="Ghi chú"></textarea>
                                  </div>
                              </div>
                          </form>
                      </div>
