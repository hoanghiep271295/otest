var QuestionuseList = React.createClass({
   ...
   */
    ...
    render: function () {
        return (
            ...
            <QuestionusePopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
