...
namespace IS.uni{
public class CONTENTTYPE_OBJ: BusinessObject<CONTENTTYPE_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "Y{SHORD}{CCCC}";
...
//##fieldList##
	...
	public CONTENTTYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public CONTENTTYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
