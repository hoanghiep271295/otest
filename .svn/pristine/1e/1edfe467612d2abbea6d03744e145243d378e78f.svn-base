 ...
 */
var ExamHallPopup = React.createClass({
    ...
    */
    ClearThing:function()
    {
        ...
        this.refs[this.props.id + "_HALLNUMBER"].value = "";
        this.refs[this.props.id + "_MAXSTUDENT"].value = "";
        this.refs[this.props.id + "_PAPERAMOUNT"].value = "";
        this.refs[this.props.id + "_BAGGROUP"].value = "";
        this.refs[this.props.id + "_BEGINTIME"].value = "",
        this.refs[this.props.id + "_ENDTIME"].value = "",
        //Set status
    ...
    */
    SetInput: function (obj) {
        ...
        this.refs[this.props.id + "_HALLNUMBER"].value = obj.HALLNUMBER;
        this.refs[this.props.id + "_MAXSTUDENT"].value = obj.MAXSTUDENT;
        this.refs[this.props.id + "_PAPERAMOUNT"].value = obj.PAPERAMOUNT;
        this.refs[this.props.id + "_BAGGROUP"].value = obj.BAGGROUP;
        var c = moment(obj.BEGINTIME).format('YYYY-MM-DDTHH:mm:ss');
        this.refs[this.props.id + "_BEGINTIME"].value = moment(obj.BEGINTIME).format('YYYY-MM-DDTHH:mm');
        this.refs[this.props.id + "_ENDTIME"].value = moment(obj.ENDTIME).format('YYYY-MM-DDTHH:mm');
        //Set status
   ...
   */
    SaveData: function (isClose) {
        ...
        var data = {
            ...
            HALLNUMBER: this.refs[this.props.id + "_HALLNUMBER"].value,
            MAXSTUDENT: this.refs[this.props.id + "_MAXSTUDENT"].value,
            PAPERAMOUNT: this.refs[this.props.id + "_PAPERAMOUNT"].value,
            BAGGROUP: this.refs[this.props.id + "_BAGGROUP"].value,
            BEGINTIME: this.refs[this.props.id + "_BEGINTIME"].value,
            ENDTIME: this.refs[this.props.id + "_ENDTIME"].value
        }
                  ...
                  <div className="modal-dialog">
                    <div className="box box-info">
                      <div className="modal-header with-border">
                        ...
                        <h4 className="modal-title" id={id+"_form_title"} ref={id+"_form_title"}>Thêm phòng thi</h4>
                      </div>
                          ...
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-sm-4">
                                      <input type="datetime-local" className="form-control" id={id + "_BEGINTIME"} ref={id + "_BEGINTIME"} />
                                  </div>
                                   <label className="col-sm-2 control-label">Thời điểm kết thúc</label>
                                  <div className="col-sm-4">
                                     <input type="datetime-local" className="form-control" id={id + "_ENDTIME"} ref={id + "_ENDTIME"} />
                                  </div>
                              </div>
                              
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Chỉ số phòng</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_HALLNUMBER"} ref={id + "_HALLNUMBER"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Số sinh viên tối đa</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_MAXSTUDENT"} ref={id + "_MAXSTUDENT"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Số tờ giấy thi</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_PAPERAMOUNT"} ref={id + "_PAPERAMOUNT"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Nhóm túi</label>
                                  <div className="col-sm-10">
                                      <input type="number" className="form-control" id={id + "_BAGGROUP"} ref={id + "_BAGGROUP"} />
                                  </div>
                              </div>
                              <div className="form-group">
