...
var Combobox3 = React.createClass({
    ...
    updatedata: function updatedata(data, type, name) {
    ...
    render: function render() {
        ...
        return React.createElement('select', { id: this.props.id, name: 'cboName', className: 'form-control' });
    }
});
