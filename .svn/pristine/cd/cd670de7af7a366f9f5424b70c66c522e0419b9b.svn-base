    ...
    getInitialState: function() {
        return {
            ...
            columnDefs: [
                ...
                {
                    headerName: "",
                    button: { text: 'Tạo phòng', className: 'createHall' },
                    width: 100,
                    editable: false,
                    type: 'button'
                },
                {
                    headerName: "",
                    button: { text: 'Tạo đề', className: 'createExamform' },
                    width: 100,
                    editable: false,
                    type: 'button'
                }
    ...
    render: function() {
        return (
            <div id={this.props.id +'_list'} className="tab-pane fade in active ">
                <ExamTimePopup setData={this
                    .setData} onPre={this
                    .onPrevClick} onNext={this
                    .onNextClick} ReloadData={this
                    .ReloadList} ref={this.props
                    .id +
                    '_Popup'} id={this.props.id + '_Popup'} parent={this.props
                    .parent} listTestStruct={this.state.listTestStruct}/>
