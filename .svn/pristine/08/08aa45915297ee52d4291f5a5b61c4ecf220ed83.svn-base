var SubjectList = React.createClass( {
    ...
    */
    registerButton: function () {
       ...
       var  obj = [{ ref: 'cmdAdd', callback: this.onNewClick }
...
//        console.log('RowSelect:', itemSelect);
       ...
       //     debugger
        ...
        this.props.parent.setKeyValue('subjectCode', itemSelect[0] );
    },
    /**
...
*/
    ...
    */
    onEditClick: function () {
       // console.log̣̣(this.state.rowSelect);
...
*/
   ...
   */
    onPrint: function () {
        ...
        var parameter = "code=" + this.state.currentcode + "&reporttype=subject";
    ...
    render: function () {
        return (
                <div id={this.props.id+'_list'} className="tab-pane fade in active ">{/*Cần phải gán ref để truy xuất đến đối tượng này*/}
                 <SubjectPopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
