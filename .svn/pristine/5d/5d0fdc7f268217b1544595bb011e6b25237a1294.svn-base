...
namespace IS.uni{
public class DEPARTMENTHISTORY_OBJ: BusinessObject<DEPARTMENTHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public DEPARTMENTHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public DEPARTMENTHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
