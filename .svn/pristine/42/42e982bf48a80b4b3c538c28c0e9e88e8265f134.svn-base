 ...
 */
var CountLevelTitlePopup = React.createClass({
    ...
    */
    ClearInput:function(obj){
        this.refs.department_popup_parentcode.value = obj.PARENTCODE;
        this.refs.department_popup_parentextcode.value = obj.PARENTEXT;
        this.refs.department_popup_thetype.value = obj.THETYPE;
    ...
    */
    ClearThing:function()
    {
        this.refs.department_popup_code.value = '';
        ...
        //Set status
        this.refs.department_popup_status.innerHTML = 'new';
    ...
    */
    SetInput: function (obj) {
        this.refs.department_popup_code.value = obj.CODE;
        this.refs.department_popup_parentcode.value = obj.PARENTCODE;
        this.refs.department_popup_parentextcode.value = obj.PARENTEXT;
        this.refs.department_popup_thetype.value = obj.THETYPE;
        this.refs.txtParent.value = obj.PARENTNAME;
        ...
        //Set status
        this.refs.department_popup_status.innerHTML = 'edit';
    },
    /**
...
//        console.log("Ghi dữ liệu");
        ...
        //default
        var CODE = this.refs.department_popup_code.value;
        var PARENTCODE = this.refs.department_popup_parentcode.value;
        var EXTENSIONCODE = this.refs.department_popup_parentextcode.value;
        var THETYPE = this.refs.department_popup_thetype.value;
          ...
          <div className="box box-info" >
            ...
            <div className="box-header with-border">
              ...
              <h3 className="box-title">Cập nhật Đơn vị</h3>              
                <input type="hidden" id="department_popup_code" ref="department_popup_code" />{/*Lưu lại mã code của bản ghi hiện tại*/}
                <input type="hidden" id="department_popup_parentcode" ref="department_popup_parentcode" />{/*Lưu lại mã code của cha hiện tại*/}
                <input type="hidden" id="department_popup_parentextcode" ref="department_popup_parentextcode" />{/*Lưu lại mã extcode của cha hiện tại*/}
                <input type="hidden" id="department_popup_thetype" ref="department_popup_thetype" />{/*Lưu lại mã kiểu menu hiện tại*/}
            </div>
              {/*Nội dung của form*/}
            ...
            <form className="form-horizontal">
              <div className="box-body">
                ...
                <div className="form-group">
                  <label htmlFor="txtCodeview" className="col-sm-3 control-label">Mã đơn vị</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="txtCodeview" ref='txtCodeview' placeholder="Mã đơn vị" />
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="txtName" className="col-sm-3 control-label">Tên đơn vị</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="txtName" ref='txtName' placeholder="Tên đơn vị" />
                  </div>
                </div>
                <div className="form-group">
              ...
              <div className="box-footer modal-footer">
                <span className="label label-warning" style={{float:'left'}} id="department_popup_status" ref='department_popup_status'>i</span>
