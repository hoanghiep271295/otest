...
namespace IS.uni{
public class STUDENTDISCIPLINETYPE_OBJ: BusinessObject<STUDENTDISCIPLINETYPE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTDISCIPLINETYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTDISCIPLINETYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
	...
	protected override fieldInfo[] _code {
	 ...
	 [tablereference("STUDENTDISCIPLINELEVEL", "CODE", "GENLEVELCODE")]
   public STUDENTDISCIPLINELEVEL_OBJ _GENLEVELCODE;
