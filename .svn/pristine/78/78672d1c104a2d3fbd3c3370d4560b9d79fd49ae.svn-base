 ...
 */
var GradePopup = React.createClass({
    ...
    */
    ClearThing:function()
    {
        ...
        this.refs[this.props.id + "_YEARIN"].value = "";
        this.refs[this.props.id + "_YEAROUT"].value = "";
        //Set status
    ...
    */
    SetInput: function (obj) {
        ...
        this.refs[this.props.id + "_YEARIN"].value = obj.YEARIN;
        this.refs[this.props.id + "_YEAROUT"].value = obj.YEAROUT;
        //Set status
   ...
   */
    SaveData: function (isClose) {
        var data = {
            ...
            YEARIN: this.refs[this.props.id + "_YEARIN"].value,
            YEAROUT: this.refs[this.props.id + "_YEAROUT"].value
        }
        //console.log(data);
        //Add or edit 1 item
        $.ajax({
                    ...
                    <div className="box box-info">
                      ...
                      <div className="modal-body">
                          <form className="form-horizontal" role="form">
                              ...
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Năm vào</label>
                                  <div className="col-sm-10">
                                      <input type='number' className="form-control" rows="4" id={id+"_YEARIN"} ref={id+"_YEARIN"} />
                                  </div>
                              </div>
                              <div className="form-group">
                                  <label className="col-sm-2 control-label">Năm ra</label>
                                  <div className="col-sm-10">
                                      <input type='number' className="form-control" rows="4" id={id+"_YEAROUT"} ref={id+"_YEAROUT"} />
                                  </div>
                              </div>
                          </form>
                      </div>
