...
namespace IS.uni{
public class EQUIPMENTLEVEL_OBJ: BusinessObject<EQUIPMENTLEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public EQUIPMENTLEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public EQUIPMENTLEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
