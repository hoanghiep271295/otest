var ArmyrankList = React.createClass( {
    getInitialState: function() {
        return {
            ...
            parentcode: '',
            parentname:'',
            parentnamedef: 'Danh mục cấp bậc 2222',
            parentextcode: '',
            searchstatus: [],
...
*/
   ...
   */
    onPrint: function () {
        ...
        var parameter = "code=" + this.state.currentcode + "&reporttype=ARMYRANK";
    ...
    render: function () {
        return(
                ...
                <ArmyrankPopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
