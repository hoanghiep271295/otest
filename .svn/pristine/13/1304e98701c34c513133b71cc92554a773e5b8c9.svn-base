...
namespace IS.uni{
public class GRADETYPE_OBJ: BusinessObject<GRADETYPE_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "P{SHORD}{CCCC}";
...
//##fieldList##
	...
	public GRADETYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public GRADETYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
