...
namespace IS.uni{
public class SUBJECTCONTENT_OBJ: BusinessObject<SUBJECTCONTENT_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public SUBJECTCONTENT_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public SUBJECTCONTENT_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
