...
namespace IS.uni{
public class PARTYLEVELTITLE_OBJ: BusinessObject<PARTYLEVELTITLE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public PARTYLEVELTITLE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public PARTYLEVELTITLE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
