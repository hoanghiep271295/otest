...
namespace IS.uni{
public class QUESTIONUSE_OBJ: BusinessObject<QUESTIONUSE_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "U{SHORD}{CCCC}";
...
//##fieldList##
	...
	public QUESTIONUSE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public QUESTIONUSE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("UNVERSITYCODE",10,"VARCHAR",0)
,new fieldInfo("LANGUAGECODE",10,"VARCHAR",0)
    ...
    public virtual System.String UNVERSITYCODE
    {
        get ;
        set ;
    }
