...
namespace IS.uni{
public class STAFFSTATUSHISTORY_OBJ: BusinessObject<STAFFSTATUSHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STAFFSTATUSHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STAFFSTATUSHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
