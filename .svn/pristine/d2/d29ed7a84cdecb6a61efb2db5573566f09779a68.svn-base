    ...
    render: function () {
        return (
                ...
                {/*Cần phải gán ref để truy xuất đến đối tượng này*/}
                                       <ReligionPopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
