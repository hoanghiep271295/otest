...
namespace IS.uni{
public class WEEKDAY_OBJ: BusinessObject<WEEKDAY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public WEEKDAY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("WEEKDAY",0,"INT",0)
,new fieldInfo("NAME",100,"NVARCHAR",0)
,new fieldInfo("ISOFF",0,"INT",0)
...
,new fieldInfo("LANG",10,"VARCHAR",0)
    ...
    public virtual System.Int32 WEEKDAY
    {
        get ;
        set ;
    }
    ...
    public virtual System.Int32 ISOFF
    {
        get ;
        set ;
    }
