...
namespace IS.uni{
public class COURSESTUDIED_OBJ: BusinessObject<COURSESTUDIED_OBJ.BusinessObjectID>
{
	[Serializable]
...
,new fieldInfo("COURSECONTENTCODE",10,"VARCHAR",0)
,new fieldInfo("STARTTIME",0,"DATETIME",0)
,new fieldInfo("HALLCODE",50,"VARCHAR",0)
,new fieldInfo("STAFFCODE",10,"VARCHAR",0)
 ...
 [tablereference("COURSECONTENT", "CODE", "COURSECONTENTCODE")]
   public COURSECONTENT_OBJ _COURSECONTENTCODE;
    ...
    public virtual System.String COURSECONTENTCODE
    {
        get ;
        set ;
    }
