...
namespace IS.uni{
public class PRIORITYPOLICY_OBJ: BusinessObject<PRIORITYPOLICY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public PRIORITYPOLICY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public PRIORITYPOLICY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("FAILAMOUNT",0,"INT",0)
,new fieldInfo("MARK",18,"DECIMAL",2)
    ...
    public virtual System.Int32 FAILAMOUNT
    {
        get ;
        set ;
    }
