 ...
 */
var EthnicPopup = React.createClass({
    ...
    */
    ClearInput:function(obj){
        this.refs.ethnic_popup_parentcode.value = obj.PARENTCODE;
        this.refs.ethnic_popup_parentextcode.value = obj.PARENTEXT;
        this.refs.ethnic_popup_thetype.value = obj.THETYPE;
    ...
    */
    ClearThing:function()
    {
        this.refs.ethnic_popup_code.value = '';
        ...
        //Set status
        this.refs.ethnic_popup_status.innerHTML = 'new';
    ...
    */
    SetInput: function (obj) {
        this.refs.ethnic_popup_code.value = obj.CODE;
        this.refs.ethnic_popup_parentcode.value = obj.PARENTCODE;
        this.refs.ethnic_popup_parentextcode.value = obj.PARENTEXT;
        this.refs.ethnic_popup_thetype.value = obj.THETYPE;
        //   this.refs.txtParent.value = obj.PARENTNAME;
        ...
        //Set status
        this.refs.ethnic_popup_status.innerHTML = 'edit';
    },
    /**
    ...
    */
    SaveData:function(isClose){
        ...
        //default
        var CODE = this.refs.ethnic_popup_code.value;
        var PARENTCODE = this.refs.ethnic_popup_parentcode.value;
        var EXTENSIONCODE = this.refs.ethnic_popup_parentextcode.value;
        var THETYPE = this.refs.ethnic_popup_thetype.value;

        var data = {
            NAME    : NAME,
            CODEVIEW: CODEVIEW,
            zzzTHEORDER: THEORDER,
            NOTE: NOTE,
    ...
    <div className="modal-dialog">
          <div className="box box-info" >
            ...
            <div className="box-header with-border">
              ...
              <h3 className="box-title">Cập nhật Dân Tộc</h3>              
                <input type="hidden" id="ethnic_popup_code" ref="ethnic_popup_code" />{/*Lưu lại mã code của bản ghi hiện tại*/}
                <input type="hidden" id="ethnic_popup_parentcode" ref="ethnic_popup_parentcode" />{/*Lưu lại mã code của cha hiện tại*/}
                <input type="hidden" id="ethnic_popup_parentextcode" ref="ethnic_popup_parentextcode" />{/*Lưu lại mã extcode của cha hiện tại*/}
                <input type="hidden" id="ethnic_popup_thetype" ref="ethnic_popup_thetype" />{/*Lưu lại mã kiểu menu hiện tại*/}
            </div>
        {/*Nội dung của form*/}
  ...
  <form className="form-horizontal">
    <div className="box-body">
      ...
      <div className="form-group">
        <label htmlFor="txtCodeview" className="col-sm-3 control-label">Mã dân tộc</label>
        <div className="col-sm-9">
          <input type="text" className="form-control" id="txtCodeview" ref='txtCodeview' placeholder="Mã dân tộc" />
        </div>
      </div>
      <div className="form-group">
        <label htmlFor="txtName" className="col-sm-3 control-label">Tên dân tộc</label>
        <div className="col-sm-9">
          <input type="text" className="form-control" id="txtName" ref='txtName' placeholder="Tên dân tộc" />
        </div>
      </div>
      <div className="form-group">
      ...
      <div className="form-group">
        ...
        {/*Các nút lệnh ở dưới*/}
          ...
          <div className="box-footer modal-footer">
            <span className="label label-warning" style={{float:'left'}} id="ethnic_popup_status" ref='ethnic_popup_status'>i</span>
