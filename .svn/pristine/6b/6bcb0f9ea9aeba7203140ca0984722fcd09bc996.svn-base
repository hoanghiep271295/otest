...
namespace IS.uni{
public class CONTENTLEVEL_OBJ: BusinessObject<CONTENTLEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public CONTENTLEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public CONTENTLEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("LEAF",0,"INT",0)
    ...
    public virtual System.Int32 LEAF
    {
        get ;
        set ;
    }
