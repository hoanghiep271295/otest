...
namespace IS.uni{
public class STUDENTMORALHISTORY_OBJ: BusinessObject<STUDENTMORALHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTMORALHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTMORALHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("MARK1",4,"VARCHAR",0)
,new fieldInfo("MARK2",4,"VARCHAR",0)
,new fieldInfo("MARK3",4,"VARCHAR",0)
,new fieldInfo("MARK",0,"INT",0)
,new fieldInfo("MORALTYPECODE",10,"VARCHAR",0)
...
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
 ...
 [tablereference("MORALTYPE", "CODE", "MORALTYPECODE")]
   public MORALTYPE_OBJ _MORALTYPECODE;
    ...
    public virtual System.String MARK1
    {
        get ;
        set ;
    }
    public virtual System.String MARK2
    {
        get ;
        set ;
    }
    public virtual System.String MARK3
    {
        get ;
        set ;
    }
    ...
    public virtual System.String MORALTYPECODE
    {
        get ;
        set ;
    }
