...
namespace IS.uni{
public class TESTSTRUCT_OBJ: BusinessObject<TESTSTRUCT_OBJ.BusinessObjectID>
{
	[Serializable]
	...
	//main object
	protected string _codeP= "T{SHORD}{CCCC}";
...
//##fieldList##
	...
	public TESTSTRUCT_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public TESTSTRUCT_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("TOTALTIME",0,"FLOAT",0)
    ...
    public virtual System.Double TOTALTIME
        {
        get;
        set;
    }
