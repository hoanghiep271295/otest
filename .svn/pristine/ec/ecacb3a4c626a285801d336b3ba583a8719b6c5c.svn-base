...
namespace IS.uni{
public class STUDENTGROUPTYPE_OBJ: BusinessObject<STUDENTGROUPTYPE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTGROUPTYPE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTGROUPTYPE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
