...
namespace IS.uni{
public class STUDENTLEVELTITLE_OBJ: BusinessObject<STUDENTLEVELTITLE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTLEVELTITLE_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTLEVELTITLE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
