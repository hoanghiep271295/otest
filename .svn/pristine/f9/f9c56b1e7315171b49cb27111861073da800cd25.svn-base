    ...
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Index(string id)
        {
            ...
            string[] jsx = {
                ...
                ,"/jsx/Core/Department/Departmentpopup.jsx"
                ,"/jsx/_shared/AgGrid.jsx"
                ,"/Jsx/_Shared/ButtonList.jsx"
                ,"/jsx/Core/Department/Departmentlist.jsx"
                };
            ViewBag.jsx = jsx;
        ...
        {
            //Đến trang thông báo khi không có phân quyền sử dụng chức năng này
            if (_ses.func("SUPADMIN") <= 0)
            {
                _ses.gotoPage("/staff/login", "Thông báo", "Không có quyền thực hiện chức năng", 3000);
                return Redirect("/common/index");
            }
            //Gán dữ liệu mặc định cho phần chọn 
            if (string.IsNullOrEmpty(id))
...
//            string thetype = "BACKEND";
        ...
        public JsonResult listparent(string thetype)
        {
            ...
            List<SYSMENU_OBJ> li = bus.getAllBy2("THEORDER", new fieldpara("THETYPE", thetype), new fieldpara("UNIVERSITYCODE", _ses.gUNIVERSITYCODE));
