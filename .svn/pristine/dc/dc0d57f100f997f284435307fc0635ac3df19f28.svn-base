...
namespace IS.uni{
public class PARTYLEVELTITLEHISTORY_OBJ: BusinessObject<PARTYLEVELTITLEHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public PARTYLEVELTITLEHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public PARTYLEVELTITLEHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
