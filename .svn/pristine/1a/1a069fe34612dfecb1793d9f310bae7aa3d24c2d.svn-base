var PartyleveltitleList = React.createClass({
...
*/
    loadData: function (obj, selectobject) {
        ...
        $.ajax({
            url: "/partyleveltitle/getAllSearch",
            dataType: 'json',
            data: {
                page: page
                , pageSize: pageSize
        ...
        return (
                <div id={this.props.id+'_list'} className="tab-pane fade in active ">
                    {/*Cần phải gán ref để truy xuất đến đối tượng này*/}
                                       <PartyleveltitlePopup setData={this.setData} onPre={this.onPrevClick} onNext={this.onNextClick} ReloadData={this.ReloadList} ref={this.props.id+'_Popup'} id={this.props.id+'_Popup'} />
