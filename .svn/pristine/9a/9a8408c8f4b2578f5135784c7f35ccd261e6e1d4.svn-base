...
namespace IS.uni{
public class LEVELTITLEHISTORY_OBJ: BusinessObject<LEVELTITLEHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public LEVELTITLEHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public LEVELTITLEHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
