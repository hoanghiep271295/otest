...
namespace IS.uni{
public class DAYOFF_OBJ: BusinessObject<DAYOFF_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public DAYOFF_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("DAYOFF",0,"DATETIME",0)
,new fieldInfo("ALLYEAR",0,"INT",0)
...
,new fieldInfo("LANG",10,"VARCHAR",0)
    ...
    public virtual System.DateTime DAYOFF
    {
        get ;
        set ;
    }
    [Display(Name="Lặp lại")]
    public virtual System.Int32 ALLYEAR
    {
        get ;
        set ;
    }
