    ...
    */
    ...
    SaveData: function (isClose) {
        var obj = {
            ...
            subjectcontentcode: this.props.parent.getKeyValue('subjectcontentcode'),
       ...
       // console.log('Save for:', obj);
        ...
        this.state.childpopup.SaveData(obj,function () {
            if (isClose) { this.Hide(); } else
            { this.ClearInput({});} this.ReloadData();}.bind(this)
             , function () { log.show("Ghi lỗi!", false); }
             , function () {log.show("Lỗi thực hiện thao tác!", false); }
        );
    },
    /**
