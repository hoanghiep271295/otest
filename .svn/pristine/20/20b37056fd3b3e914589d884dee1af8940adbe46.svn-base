...
namespace IS.uni{
public class STUDENTDISCIPLINELEVEL_OBJ: BusinessObject<STUDENTDISCIPLINELEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTDISCIPLINELEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTDISCIPLINELEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
