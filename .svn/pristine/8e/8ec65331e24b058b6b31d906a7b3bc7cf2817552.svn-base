...
namespace IS.uni{
public class STUDENTDISCIPLINEHISTORY_OBJ: BusinessObject<STUDENTDISCIPLINEHISTORY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public STUDENTDISCIPLINEHISTORY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public STUDENTDISCIPLINEHISTORY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("STUDENTDISCIPLINTYPEECODE",10,"VARCHAR",0)
,new fieldInfo("OFFICIALNUMBER",20,"NVARCHAR",0)
,new fieldInfo("OFFICIALDATET",0,"DATETIME",0)
,new fieldInfo("THEMONTH",0,"INT",0)
,new fieldInfo("THEYEAR",0,"INT",0)
,new fieldInfo("STUDENTDISCIPLINELEVELLINK",0,"INT",0)
...
,new fieldInfo("UNIVERSITYCODE",10,"VARCHAR",0)
 ...
 [tablereference("STUDENTDISCIPLINETYPE", "CODE", "STUDENTDISCIPLINETYPECODE")]
   public STUDENTDISCIPLINETYPE_OBJ _STUDENTDISCIPLINETYPECODE;
    ...
    public virtual System.String STUDENTDISCIPLINTYPEECODE
    {
        get ;
        set ;
    }
    ...
    public virtual System.DateTime OFFICIALDATET
    {
        get ;
        set ;
    }
    ...
    public virtual System.Int32 STUDENTDISCIPLINELEVELLINK
    {
        get ;
        set ;
    }
