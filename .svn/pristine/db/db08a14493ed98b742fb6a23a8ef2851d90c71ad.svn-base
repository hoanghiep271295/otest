var AdmingroupStaff = React.createClass({
...
//        console.log(itemSelect);
 ...
 //       console.log('admingroupstaff-loadData:', new Date());
        var ret;
        var that = this;
    ...
    render: function () {
        return (
            ...
            <div id={this.props.id+'_list'} className="tab-pane fade in active ">
               ...
               <AdmingroupPopup ref={this.props.id+'_popup'}  ReloadData={this.ReloadList}/> 
