...
//Danh sách các nút lệnh thực hiện chức năng
            ...
            parentcode: '',
            parentname: 'Hệ thống menu',
            parentnamedef: 'Hệ thống menu',
            parentextcode:''
    };
    },
...
*/
 ...
 //       this.setState({ parentcode: obj[0].id, parentextcode: obj[0].idext, parentname: obj[0].name });
    ...
    onEidtClick: function () {
        ...
        else
        {
            ...
            var obj = { NAME: currentobj.NAME
                ...
                , PRIORITYCODE: currentobj.PRIORITYCODE
    ...
    <div className="box">
        <div className="row">
            ...
            <div className="col-xs-3" style={{borderRight: '1px solid gray', minHeight:550}}>
                <a href="#" onClick={this.TreeSelect}>Hệ thống menu</a>
                <Tree id='sysmenu_list_tree' data={this.state.lst} mapper={config} callback={this.TreeSelect} height='515px'/>
            </div>
