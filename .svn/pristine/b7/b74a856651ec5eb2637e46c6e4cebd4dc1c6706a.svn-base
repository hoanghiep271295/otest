...
namespace IS.uni{
public class LEVELTITLRPRIORITY_OBJ: BusinessObject<LEVELTITLRPRIORITY_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public LEVELTITLRPRIORITY_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public LEVELTITLRPRIORITY_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
