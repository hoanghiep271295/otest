...
namespace IS.uni{
public class DEGREE_OBJ: BusinessObject<DEGREE_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public DEGREE_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("RATE",0,"FLOAT",0)
    ...
    [Display(Name="Hệ só giảm tải giảng dạy")]
    ...
    [Display(Name="Tải giảng dạy (Khoa quân sự)")]
    public virtual System.Int32 EDUDUTY1
    {
        get ;
        set ;
    }
    [Display(Name="Tải nghiên cứu (Khoa quân sự)")]
