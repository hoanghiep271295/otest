 ...
 */
var WarehouselevelPopup = React.createClass({
    ...
    */
    SetInput: function (obj) {
        this.refs.popup_code.value = obj.CODE;
        ...
        this.refs.popup_status.innerHTML = 'edit';
    },
    /**
...
//        console.log("Ghi dữ liệu");
        ...
        //default
        var CODE = this.refs.popup_code.value;
    ...
    <div className="modal-dialog">
          <div className="box box-info" >
            ...
            <div className="box-header with-border">
              ...
              <h3 className="box-title">Cập nhật cấp kho</h3>              
                <input type="hidden" id="popup_code" ref="popup_code" />{/*Lưu lại mã code của bản ghi hiện tại*/}
            </div>
              {/*Nội dung của form*/}
            ...
            <form className="form-horizontal">
              ...
              <div className="box-footer modal-footer">
                <span className="label label-warning" style={{float:'left'}} id="popup_status" ref='popup_status'>i</span>
