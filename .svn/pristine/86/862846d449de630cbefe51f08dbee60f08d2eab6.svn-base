...
namespace IS.uni{
public class ACADEMICLEVEL_OBJ: BusinessObject<ACADEMICLEVEL_OBJ.BusinessObjectID>
{
	[Serializable]
...
//##fieldList##
	...
	public ACADEMICLEVEL_OBJ()
	{
		base._ID = new BusinessObjectID();
	}

	public ACADEMICLEVEL_OBJ(BusinessObjectID id)
	{
		base._ID = new BusinessObjectID();
		base._ID = id;
	}
...
,new fieldInfo("RESEARCHDUTY1",0,"INT",0)
    ...
    [Display(Name="Hệ số giảm tải giảng dạy")]
    public virtual System.Int32 EDUREDUCERATE
    {
        get ;
        set ;
    }
    [Display(Name="Hệ số giảm tải nghiên cứu")]
    ...
    [Display(Name="Tải giảng dạy GVQS")]
    public virtual System.Int32 EDUDUTY1
    {
        get ;
        set ;
    }
    [Display(Name="Tải nghiên cứu GVQS")]
